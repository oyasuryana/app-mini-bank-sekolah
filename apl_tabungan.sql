...
--
-- Host: localhost:3306
-- Generation Time: Feb 03, 2020 at 11:22 AM
...
INSERT INTO `dataNasabah` (`NoRekening`, `NamaNasabah`, `JenisKelamin`, `TempatLahir`, `TanggalLahir`, `NoHandphone`, `AlamatNasabah`) VALUES
('18075', 'Dadan Abdilah', 'L', 'Kuningan', '2002-11-12', '09787878787', 'Desa Kutawaringin'),
('19001', 'Oya Suryana', 'L', 'Kuningan', '2018-07-19', '085224191648', 'Bayuning'),
('19002', 'Rika Widianingsih, S.Pd.', 'P', 'Kuningan', '1998-07-18', '0897897878979', 'Bayuning'),
('19003', 'Abiq', 'L', 'Kuningan', '2010-09-20', '08987897878', 'Bayuning'),
('19004', 'Farhan', 'L', 'Kuningan', '2008-10-01', '09098098', 'Kuningan');
...
CREATE TABLE `dataUser` (
  ...
  `levelUser` enum('teller','manager','admin','cs') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('tanti', '202cb962ac59075b964b07152d234b70', 'Tanti Amelia', 'teller');
...
--
ALTER TABLE `dataSimpanan`
  MODIFY `IdSimpanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
